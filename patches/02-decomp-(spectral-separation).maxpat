...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"patching_rect" : [ 497.265625, 316.796875, 86.421875, 22.0 ],
									"text" : "fluid.nmffilter~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 379.6875, 316.796875, 94.0, 22.0 ],
									"text" : "fluid.nmfmatch~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 376.911464482545853, 263.2291639149189, 234.765625, 47.0 ],
									"text" : "no real-time equivalent. the algorithm needs to work on on a buffer, but see (below) for related real-time objects"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 366.364589482545853, 25.786458849906921, 150.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 21.833331823348999, 20.333333373069763, 150.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 15.166664958000183, 202.666664779186249, 110.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 381.78125, 202.666664779186249, 93.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "signal", "signal", "" ],
									"patching_rect" : [ 381.78125, 132.833332180976868, 69.0, 22.0 ],
									"text" : "fluid.sines~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 39.166664958000183, 132.833332180976868, 86.0, 22.0 ],
									"text" : "fluid.bufsines~"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 381.78125, 63.499999523162842, 66.0, 22.0 ],
									"text" : "fluid.hpss~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 45.833331823348999, 63.499999523162842, 83.0, 22.0 ],
									"text" : "fluid.bufhpss~"
								}
...
,
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 39.666665732860565, 42.11347496509552, 534.666666746139526, 101.999999046325684 ],
									"pitchcorrection" : 0,
									"quality" : "basic",
									"timestretch" : [ 0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 276.000008225440979, 239.333341704139684, 247.333336234092712, 22.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 72.666668832302094, 360.000010669231415, 150.0, 20.0 ],
					"text" : "2. run fluid.bufhpss~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 440.833323895931244, 264.666674554347992, 184.000001013278961, 20.0 ],
					"text" : "3. play harmonic component"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 440.833323895931244, 468.333346486091614, 123.0, 22.0 ],
					"text" : "set drum-loop-perc, 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 440.833323895931244, 292.000008702278137, 127.0, 22.0 ],
					"text" : "set drum-loop-harm, 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "signal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 674.166664183139801, 472.113489329814911, 136.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 674.166664183139801, 535.446824550628662, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 674.166664183139801, 435.333346307277679, 38.0, 22.0 ],
					"text" : "play~"
				}
...
, 			{
				"box" : 				{
					"color" : [ 0.686274509803922, 0.274509803921569, 0.694117647058824, 1.0 ],
					"id" : "obj-22",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 290.833333909511566, 468.333346486091614, 131.0, 22.0 ],
					"text" : "buffer~ drum-loop-perc"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 286.833333909511566, 292.000008702278137, 135.0, 22.0 ],
					"text" : "buffer~ drum-loop-harm"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 270.000008046627045, 500.000014901161194, 334.666674733161926, 92.000000834465027 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 270.000008046627045, 326.66667640209198, 334.666674733161926, 92.000000834465027 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 39.666665732860565, 358.000010669231415, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 39.666665732860565, 394.000011742115021, 195.0, 49.0 ],
					"text" : "fluid.bufhpss~ @source drum-loop @harmonic drum-loop-harm @percussive drum-loop-perc"
				}
...
,
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 49.166665732860565, 453.0, 255.0, 453.0, 255.0, 321.0, 279.500008046627045, 321.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-26", 0 ],
					"midpoints" : [ 450.333323895931244, 492.0, 435.0, 492.0, 435.0, 429.0, 683.666664183139801, 429.0 ],
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-41::obj-7" : [ "live.gain~[2]", "live.gain~", 0 ],
